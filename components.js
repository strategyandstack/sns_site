...
<div class="roadmap-item flex items-stretch gap-5 group" style="width:100%" data-index="${idx}">
    <div class="roadmap-number flex-shrink-0 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center font-black text-white text-base" style="width:48px;min-width:48px">${idx + 1}</div>
